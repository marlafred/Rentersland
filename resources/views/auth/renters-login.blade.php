...
<div class="col-sm-12 clmn">
    <div class="overlay-box">
        <span class="step-label">Renter Login</span>
        <div class="content">
            @if (count($errors))
            ...
            <form method="POST" action="{{ route('user.login.submit') }}">
                ...
                <div class="form-group">
                	<a class="text-danger prom-text" href="{{ route('tenant.register') }}" style="color:#d92228; font-size:18px;">
