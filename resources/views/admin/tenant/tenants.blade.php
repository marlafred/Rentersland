...
<div class="panel panel-default">
    <div class="panel-heading" style="background-color: #c5dcf1;">
        <b><i class="fa fa-user"></i> &nbsp;Tenant List </b>
    </div>
    ...
    <form method="get" id="update_multi" onsubmit="return false;">
        ...
        <input type="hidden" name="user_type" value="renter_activate">
    </form>
    </div>
    ...
    <div class="box-body" style="overflow-x: auto; padding: 0;">
        ...
        <table id="users" class="display" cellspacing="0" style="overflow-x: auto;" width="100%">
            <thead>
                <tr>
...
<td>
                    ...
                    <td>
                        <a href="{{ route('tenant.files') }}/{{ $user->id }}" class="text-primary"><i class="fa fa-eye"></i> View Files <span class="badge">{{ count($user->files) }}</span></a>
                    </td>
