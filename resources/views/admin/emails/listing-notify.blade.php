...
@section('title', 'New Listing Email Template')
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b><i class="fa fa-envelope"></i> New Listings Template </b>
                </div>
                ...
                <div class="box-body" style="padding: 3% 6%;">
                    <form id="addForm" role="form" onSubmit="return false;">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="label-control"> Admin Noti Email </label>
                                <input type="text" name="admin_email" class="form-control" required placeholder="Admin Email" value="{{ isset($register->admin_email)?$register->admin_email:'info@rentersland.com' }}" />
                        ...
                        <input type="hidden" value="listing_notify" name="type">
                    </form>
                </div> <!--box-body-->
            </div>
