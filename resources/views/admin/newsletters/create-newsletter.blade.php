        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b><i class="fa fa-plus"></i> Create Newsletter </b>
                </div>
                ...
                <div class="box-body" style="padding: 3% 6%;">
                    <form id="addForm" role="form" onSubmit="return false;">
                        {{ csrf_field() }}
                         <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" class="form-control" required placeholder="Write some subject" value="{{ isset($newsletter->subject)?$newsletter->subject:'' }}" />
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="content" style="width:100%">{{ isset($newsletter->content)?$newsletter->content:'' }}</textarea>
                        </div>
                        ...
                        <input type="hidden" value="{{ isset($newsletter->id)?$newsletter->id:'' }}" name="id">
                    </form>
                </div> <!--box-body-->
            </div>
	...
	$(document).ready(function() {
	  ...
	  **/
	  $('#addForm').on('submit', function(e){
                ...
                $.ajax({
                    type:"POST",
                    url:"{{ route('admin.submit.newsletter') }}",
