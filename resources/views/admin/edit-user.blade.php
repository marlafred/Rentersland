...
<div class="panel panel-default">
    <div class="panel-heading" style="background-color: #c5dcf1;">
        <b><i class="fa fa-pencil"></i> &nbsp; Edit Profile </b>
    </div>
        ...
        <form method="POST" action="{{ route('update.user', $user->id) }}">
            ...
            <div class="form-group col-sm-6">
                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                    ...
                    <input id="first_name" type="text" placeholder="First Name *" class="form-control" name="first_name" value="{{ $user->first_name }}" required autofocus>
                </div>
            </div>
            ...
            <div class="form-group col-sm-6">
                <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                    ...
                    <input id="last_name" type="text" placeholder="Last Name *" class="form-control" name="last_name" value="{{ $user->last_name }}" required>
                </div>
            </div>
            ...
            <div class="form-group col-sm-6">
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input id="email" type="email" placeholder="Email Address *" class="form-control" name="email" value="{{ $user->email }}" readonly="">
                </div>
            </div>
            ...
            <div class="form-group col-sm-6">
                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                    ...
                    <input id="username" type="text" placeholder="Username *" class="form-control" name="username" value="{{ $user->username }}" readonly="">
                </div>
            </div>
            <div class="clearfix"></div>    
            ...
            <div class="form-group col-sm-6">
                <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                    ...
                    <input id="phone_number" type="text" placeholder="Phone Number" class="form-control" name="phone_number" value="{{ $user->phone_number }}">
                </div>
            </div>
            ...
            @if($user->user_type=='Tenant')
                ...
                <div class="form-group col-sm-6">
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        <label>Company</label>
                        <input id="company" type="text" placeholder="Company/Organization (if any)" class="form-control" name="company" value="{{ $user->company }}">
                    </div>
                </div>
                <div class="clearfix"></div> 
            @endif
            ...
            <div class="form-group col-sm-12">
                <div class="form-group{{ $errors->has('personal_info') ? ' has-error' : '' }}">
                    ...
                    <textarea style="resize: none;" class="form-control" name="personal_info" rows="5" placeholder="Something about you ..">{{ $user->personal_info }}</textarea>
                </div>
            </div>
            ...
            <input type="hidden" name="street_name" id="street_name" value="{{ $user->street_name }}">
    ...
    <div class="col-sm-4 dash-content">
        <div class="form-group col-sm-12">
            <label>Address</label>
            <input type="text" class="form-control" placeholder="Address" id="searchAddress" value="{{ $user->address }}" name="address" />
        </div>
        <div class="form-group col-sm-12">
            <label>Map</label>
