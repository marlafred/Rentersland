...
<div class="col-sm-9 dash-content">
    ...
    <div class="opt-grid" style="margin-top: 10px;">
      <div class="row">
        <div class="col-sm-3">
            <a href="{{ route('listings') }}" class="optionbox">
                <h4><i class="fa fa-building-o" aria-hidden="true"></i> Apply Now </h4>
                <span class="badge">&nbsp;</span>
            </a>
        </div>
          
        <div class="col-sm-3">
            <a href="{{ route('user.listings.applied') }}" class="optionbox">
                <h4><i class="fa fa-building-o" aria-hidden="true"></i> Applied</h4>
                <span class="badge">{{ $listings }}</span>
            </a>
        </div>
        
        <div class="col-sm-3">
            <a href="{{ route('tenant.submitted.files') }}" class="optionbox">
                <h4><i class="fa fa-paper-plane" aria-hidden="true"></i> Documents </h4>
