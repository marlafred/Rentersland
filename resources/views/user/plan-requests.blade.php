...
@section('body')
    ...
    <div class="col-sm-9 dash-content">
        ...
        <div class="alert-box">
            <h4 class="heading"> <b>Requests ( {{ count($requests) }} )</b> </h4>
        </div>
                                ...
                                <div id="collapse-{{ $req->id }}" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="detail-footer">
                                            <div class="listing pull-left"> <a href="{{ route('detail.listing') }}/{{ $req->listing->slug }}"><i class="fa fa-external-link"></i> {{ $req->listing->title }} </a> </div>
                                            <div class="listing pull-right"> 
                                                <!-- <a href="javascript:void(0);" class="text text-primary mark-read" rel-id='{{ $req->id }}'> Mark as read </a> -->
                                                <a href="javascript:void(0);" class="btn btn-clrd reply-btn"> Reply </a>
                                            </div>
                                        </div><!--detail-footer-->
