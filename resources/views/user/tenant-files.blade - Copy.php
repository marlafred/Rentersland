...
@section('body')
    ...
    <div class="col-sm-9 dash-content">
        ...
        <h4 class="title bg"> <b> Documents Submitted ( {{ count($files) }} )</b> </h4>
        ...
        <div class="col-sm-12 listing-items">
            ...
            <div class="row" style="border: 1px solid #e5e5e5; width: 65%; margin-left: 18%;">
                <div class="col-md-12" style="padding:1% 5%;">
                    <div class="panel-heading">Upload New</div>
